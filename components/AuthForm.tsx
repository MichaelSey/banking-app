                            ...
                            <>
                                <Form {...form}>
                                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                            ...
                                            <div className="flex gap-4">
                                                <CustomInput 
                                                control={form.control} name="state" label="State" placeholder="Example: FL"/>
                                                <CustomInput 
                                                control={form.control} name="postalCode" label="Postal Code" placeholder="Example: 12315"
                                                />
                                            </div>
                                            <div className="flex gap-4">
                                                <CustomInput 
                                                ...
                                                />
                                                 <CustomInput 
                                                control={form.control} name="ssn" label="SSN" placeholder="Example: 6789"
                                                />
                                            </div>
                                                </>
                                 ...
                                 <footer className="flex justify-center gap-1">
                                    <p className="text-14 font-normal text-">{type === 'sign-in' 
